...
public interface RpcRequestedListener {
    /**
     * This listener will be invoked whenever the client recieves an rpc request from the server,
     * and will be able to respond via {@link RpcResponse#send(Object)} or {@link
     * RpcResponse#reject()}
     *
