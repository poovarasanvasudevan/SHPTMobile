...
public class RecordMergeStrategyException extends RuntimeException {
    ...
    /**
     * The error message associated with merge conflict returned by a custom {@link
     * RecordMergeStrategy}
     */
     ...
     *
     * @see RecordMergeStrategyException#RecordMergeStrategyException(int, JsonElement, int,
     * JsonElement, String)
     */
