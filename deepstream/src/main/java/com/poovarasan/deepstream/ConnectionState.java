...
public enum ConnectionState {
    /**
     * Connection is closed, usually due to closing the client or getting multiple authentication
     * rejects from server
     */
    CLOSED,
    /**
    ...
    AWAITING_CONNECTION,
    /**
     * Client has connected to a server and is now enquiring if it should open a normal connection
     * or be redirect to another server first
     */
    CHALLENGING,
    /**
    ...
    OPEN,
    /**
     * An error has occured on the connection, usually due to an recoverable connection drop or if
