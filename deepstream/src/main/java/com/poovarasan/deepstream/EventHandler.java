...
/**
 * The entry point for events, such as {@link EventHandler#subscribe(String, EventListener)}, {@link
 * EventHandler#emit(String)} and provider functionality such as {@link EventHandler#listen(String,
 * ListenListener)}
 */
public class EventHandler {
     ...
     * @param listenListener The listener to inform the client when a subscription has been found or
     *                       removed
     */
