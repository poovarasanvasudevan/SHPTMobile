...
public interface ConnectionStateListener {
    /**
     * Called with the new updated connection state. Useful for allowing your application to respond
     * to different scenarios, like {@link ConnectionState#ERROR} if an error occurs, or {@link
     * ConnectionState#RECONNECTING} if the connection drops.
     *
