...
public class RpcHandler {
    ...
    /**
     * Unregister a {@link RpcRequestedListener} registered via Rpc{@link #provide(String,
     * RpcRequestedListener)}
     *
    ...
    /**
     * Create a remote procedure call. This requires a rpc name for routing, a JSON serializable
     * object for any associated arguments and a callback to notify you with the rpc result or
     * potential error.
     *
     * @param rpcName The name of the rpc
     * @param data    Serializable data that will be passed to the provider
     * @return Find out if the rpc succeeded via {@link RpcResult#success()} and associated data via
     * {@link RpcResult#getData()}
     */
    ...
    interface RpcResponseCallback {
        /**
         * Called when the rpc was completed successfully by another client that has provided the
         * rpc via {@link RpcHandler#provide(String, RpcRequestedListener)}
         *
        ...
        /**
         * Called when the rpc was completed unsuccessfully by another client that has provided the
         * rpc via {@link RpcHandler#provide(String, RpcRequestedListener)}
         *
         * @param rpcName The rpc name
         */
