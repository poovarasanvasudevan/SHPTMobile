...
/**
 * An EventListener is notified whenever it is triggered locally or remotely. You can add an
 * EventListener via {@link EventHandler#subscribe(String, EventListener)}
 */
