...
/**
 * When setting a record with write acknowledgement {@link Record#setWithAck(String, Object)}
 * (String)} where the result is either a RecordSetResult containing an error or null.
 */
