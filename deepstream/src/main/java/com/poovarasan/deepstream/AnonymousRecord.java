...
public class AnonymousRecord {
    ...
    /**
     * Remove a callback used to be notified whenever {@link AnonymousRecord#setName(String)} is
     * called.
     *
    ...
    /**
     * Proxies the actual {@link Record#subscribe} method. The same parameters can be used. Can be
     * called prior to {@link AnonymousRecord#setName}). Please note, triggerIfReady will always be
     * set to true to reflect changes in the underlying record.
     *
