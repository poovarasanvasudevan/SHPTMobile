...
/**
 * Provides the different topics that deepstream connections use. A user of this sdk will only need
 * to access these during error messages, such as via the {@link DeepstreamException}
 */
public enum Topic {
    /**
