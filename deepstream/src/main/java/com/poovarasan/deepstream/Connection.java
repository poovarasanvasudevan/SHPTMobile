...
class Connection implements IConnection {
    ...
    /**
     * Creates an endpoint and passed it to {@link Connection#Connection(String, DeepstreamConfig,
     * DeepstreamClient, EndpointFactory, Endpoint)}
     *
     ...
     * @see Connection#Connection(String, DeepstreamConfig, DeepstreamClient, EndpointFactory,
     * Endpoint)
     */
    ...
    /**
     * Creates a connection, that is responsible for handling all the connection related logic
     * related to state and messages
     *
     * @param url      The endpoint url* @param options The options used to initialise the
     *                 deepstream client
     * @param client   The deepstream client
     ...
     * @param loginCallback  The callback for a successful / unsuccessful login attempt connection
     */
